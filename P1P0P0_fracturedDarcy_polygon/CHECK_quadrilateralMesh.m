...
n = 5; eipsilon = 1e-3; error0 = zeros(n,1); errorb = zeros(n,1); H1p = zeros(n,1); H1pGamma = zeros(n,1); maxpGamma = zeros(n,1); dof = zeros(n,1);
for i = 1:n
    [node1, elem1] = uniformrefinequad(node1, elem1); 
    [node2, elem2] = uniformrefinequad(node2, elem2); 
