function FractureDarcyP1P1RT1_P1CG_2(eipsilon, ite)
...
center1 = (node1(elem1(:,1),:) + node1(elem1(:,2),:) + node1(elem1(:,3),:))/3;
center2 = (node2(elem2(:,1),:) + node2(elem2(:,2),:) + node2(elem2(:,3),:))/3;
p1I = p1(center1); p2I = p2(center2);

err1 = getErrorPrimalDarcyP1P1RT1(node1, elem1, gcrt, gprt, p10, @p1, @p1, @p1);
err2 = getErrorPrimalDarcyP1P1RT1(node2, elem2, gcrt, gprt, p20, @p2, @p2, @p2);
