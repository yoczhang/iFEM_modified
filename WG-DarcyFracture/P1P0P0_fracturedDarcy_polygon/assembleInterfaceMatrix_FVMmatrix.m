function [I1,I2,M,D,rhs] = assembleInterfaceMatrix_FVMmatrix(node,edge,lGamma,eipsilon,psi,eitaGamma,NE,inteNE,edgeLength, ...
...
for i = 1:inteNE
    j1 = interfacesEdges_domainOne(i); j2 = interfacesEdges_domainTwo(i); 
    I1(j1,j1) = I1(j1,j1) + (co1/4 + co2) * edgeLength(j1); I1(j2,j1) = I1(j2,j1) + (co1/4 - co2) * edgeLength(j1);
    I1(j1,j2) = I1(j1,j2) + (co1/4 - co2) * edgeLength(j1); I1(j2,j2) = I1(j2,j2) + (co1/4 + co2) * edgeLength(j1);
    
    I2(j1,i) = I2(j1,i) - co1/2  * edgeLength(j1); I2(j2,i) = I2(j2,i) - co1/2  * edgeLength(j1);
